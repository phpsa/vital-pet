<section>
    <div class="p-8 overflow-hidden border-4 border-gray-900 rounded-lg ves-sale-panel ves-panel">
        <div class="sm:py-32 sm:relative">
            <div>
                <span class="ves-kicker">Limited Collection</span>

                <h2 class="mt-3 text-3xl font-extrabold sm:text-5xl ves-serif">
                ...
                <a href="{{ route('collection.view', $this->saleCollection->defaultUrl->slug) }}"
                   class="inline-block px-5 py-3 mt-6 text-sm font-medium text-white bg-black rounded-lg hover:ring-1 hover:ring-black ves-button ves-button-primary"
                   wire:navigate
                >
                    Shop This Drop
                </a>
